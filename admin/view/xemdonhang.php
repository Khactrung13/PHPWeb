<?php
   ...
   $thongtinnhanhang = loadThongTinNhanHang($_GET['code']);
...
<p style="font-size: 30px;
    font-weight: bold;
    padding-left: 550px;">Quản lý đơn hàng</p>
<p style="font-size: 20px;
    font-weight: bold;
    margin: 5px;">Thông tin nhận hàng</p>
<form style="margin-left:20px" action="controller/ThongTinNhanHang.php?id=<?php echo $_GET['id']?>" autocomplete="off" method="POST">
...
<p style="font-size: 20px;
    font-weight: bold;
    margin: 5px;">Chi tiết đơn hàng</p>
